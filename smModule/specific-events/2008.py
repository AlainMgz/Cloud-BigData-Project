...
def best_perf():
    ...
    print(f"\r\033[KThe stock {best_perf_stock} has the best performance during the 2008-2009 crisis : {best_perf} ({best_percentage}%)")
    print(f"\r\033[KThe stock {worst_perf_stock} has the worst performance during the 2008-2009 crisis: {worst_perf} ({worst_percentage}%)")
...
def worst_day():
    ...
    print(f"\r\033[KThe {worst_perf_day} was the worst day for the US market (using the Dow Jones index) during the 2008 crisis, it has a lost of: {worst_perf} ({worst_percentage}%)")
...
def good_worst_day():
    ...
    print(f"\r\033[KThe {date_event} was the worst day for the US market (using the Dow Jones index) during the 2008-2009 crisis, the stocks had an average lost of: ({res}%)")
