...
def worst_day():
    ...
    print(f"\r\033[KThe {worst_perf_day} was the worst day for the US market (using the Dow Jones indice) during the 200&-2003 crisis, it has a lost of: {worst_perf} ({worst_percentage}%)")
